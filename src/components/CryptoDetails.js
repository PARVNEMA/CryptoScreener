    ...
    >
      ...
      >
        {data ? (
          ...
          >
            {/* left */}
            <div className="flex flex-col w-[45%] h-full pr-2 " id="4">
              {/* symbol name   */}
              <div className="flex w-full items-center" id="5">
                <h1 className="text-3xl border rounded border-gray-100 px-2 py-0.5">
              ...
              {/* middle left part  price */}
              <div className="flex w-full mt-6 " id="6">
                <div className="flex flex-col w-full" id="7">
        ...
        ${
          data.market_data.price_change_percentage_24h > 0
            ...
            : "fill-red"
              ...
              <div>
                <div className="md:flex md:w-full md:mt-4 md:justify-between
              ...
              <div className="flex w-full mt-4 justify-between">
                <div className="flex flex-col">
                  ...
                  <a
                    className="text-sm bg-gray-200 text-green

                  px-1.5 py-0.5 my-1 rounded "
                    target="_blank"
                    rel="noreferrer"
            ...
            {/* right */}
            <div className="md:flex md:flex-col md:w-[55%] md:h-full md:pl-3 hidden">
              <Chart id={data.id} />
